...
> 分发顺序、三流帧协议）已在 [typert 远程协议与代码生成](./typert-remote-protocol.md)，
> 一元链/流链/信任栅栏的接线总览在 [host/client 分层与 API 网关](../platform/host-client-boundary.md)——
...
- 协议与分发内幕：[typert 远程协议与代码生成](./typert-remote-protocol.md)
- 双树总览与信任栅栏：[host/client 分层与 API 网关](../platform/host-client-boundary.md)
- 应用壳与启动序：[应用壳](../platform/web-cli-boot.md)
- 配置面 seam 本体：[配置面](../augmentation/settings-and-credentials.md)
- 预设 roster 供给侧：[能力供给](../augmentation/skills-mcp-hooks.md)
